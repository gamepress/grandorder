...
import { ServantSkillView } from "./ServantSkillView";
...
export function ServantSkill({
   ...
   const { data, error, isLoading } = useSWR(
      gql`
         query {
            ServantSkills(where:{name:{contains:"${groupSelectQuery}"}}) {
               docs {
                  id
                  name
               }
   ...
   const entryData = data?.ServantSkills?.docs;
