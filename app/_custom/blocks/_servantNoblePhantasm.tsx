...
import { ServantNoblePhantasmView } from "./ServantNoblePhantasmView";
...
export function ServantNoblePhantasm({
   element,
   children,
}: {
   element: any;
   ...
   const { data, error, isLoading } = useSWR(
      gql`
         query {
            NoblePhantasms(where:{name:{contains:"${groupSelectQuery}"}}) {
               docs {
                  id
                  name
               }
   ...
   const entryData = data?.NoblePhantasms?.docs;
         ...
         <section>
            ...
            >
               <GroupDnDContext.Provider value={{ groupItems, setGroupItems }}>
                  <ServantNoblePhantasmView refId={refId} />
